...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/apify-tiktok-scraper?style=social)](https://github.com/data-scrape/apify-tiktok-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/apify-tiktok-scraper?style=social)](https://github.com/data-scrape/apify-tiktok-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/apify-tiktok-scraper)](https://github.com/data-scrape/apify-tiktok-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/apify-tiktok-scraper)](https://github.com/data-scrape/apify-tiktok-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> Apify TikTok scraper alternative - free Python TikTok scraper


<!-- SEO keywords: apify tiktok scraper, Apify Tiktok Scraper, apify tiktok scraper python, apify tiktok scraper github -->
...
- Free Apify TikTok scraper alternative in Python
- Extract TikTok videos, profiles, and hashtags
- No Apify subscription needed
- Video download URL extraction
- Profile data: followers, following, likes, bio
- Hashtag analytics and trending content

## 🎯 Use Cases

Replace expensive Apify subscriptions with free Python alternative.
...
```bash
pip install git+https://github.com/data-scrape/apify-tiktok-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/apify-tiktok-scraper.git
...
```python
from apify_tiktok_scraper import Scraper
...
```bash
python apify_tiktok_scraper.py --query "your-query" --output results.json
```
...
### Is Apify Tiktok Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/apify-tiktok-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/apify-tiktok-scraper/issues)
